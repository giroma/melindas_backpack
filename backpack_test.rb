...
class BackpackTest < MiniTest::Test
  ...
  def test_that_shoes_packed_for_tuesday_or_thursday
  ...
  def test_that_shoes_not_packed_except_for_tuesday_or_thursday
...
- gym shoes
- packed lunch"
    assert_equal(backpack.print_list, expected)
  end
